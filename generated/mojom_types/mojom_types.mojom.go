...
func (s *StructField) Encode(encoder *bindings.Encoder) error {
	...
	if err := s.FieldType.Encode(encoder); err != nil {
		return err
	}
...
func (s *StructField) Decode(decoder *bindings.Decoder) error {
	...
	if header.ElementsOrVersion >= 0 {
		var err error
		s.FieldType, err = DecodeType(decoder)
		if err != nil {
			return err
		}
		if s.FieldType == nil {
	...
	if header.ElementsOrVersion >= 0 {
		...
		if pointer0 == 0 {
			...
			s.DefaultValue = new(ConstantOccurrence)
			if err := (*s.DefaultValue).Decode(decoder); err != nil {
				return err
			}
		}
	}
...
func (s *EnumValue) Decode(decoder *bindings.Decoder) error {
	...
	if header.ElementsOrVersion >= 0 {
		...
		if pointer0 == 0 {
			...
			if err := s.Value.Decode(decoder); err != nil {
				return err
			}
		}
	}
...
func (s *MojomInterface) Decode(decoder *bindings.Decoder) error {
	...
	if header.ElementsOrVersion >= 0 {
		...
		if pointer0 == 0 {
			...
			s.Methods = new(map[uint32]MojomMethod)
...
func (s *ConstantOccurrence) Encode(encoder *bindings.Encoder) error {
	encoder.StartStruct(24, 0)
	if s.Value == nil {
	...
	if s.Identifier == nil {
		...
		if err := (*s.Identifier).Encode(encoder); err != nil {
			return err
		}
	}
	if err := encoder.Finish(); err != nil {
...
var constantOccurrence_Versions []bindings.DataHeader = []bindings.DataHeader{
	bindings.DataHeader{32, 0},
}

func (s *ConstantOccurrence) Decode(decoder *bindings.Decoder) error {
	header, err := decoder.StartStruct()
	if err != nil {
		return err
	}
	index := sort.Search(len(constantOccurrence_Versions), func(i int) bool {
		return constantOccurrence_Versions[i].ElementsOrVersion >= header.ElementsOrVersion
	})
	if index < len(constantOccurrence_Versions) {
		if constantOccurrence_Versions[index].ElementsOrVersion > header.ElementsOrVersion {
			index--
		}
		expectedSize := constantOccurrence_Versions[index].Size
		if expectedSize != header.Size {
			return &bindings.ValidationError{bindings.UnexpectedStructHeader,
				fmt.Sprintf("invalid struct header size: should be %d, but was %d", expectedSize, header.Size),
			}
	...
	if header.ElementsOrVersion >= 0 {
		var err error
		s.Value, err = DecodeConstantValue(decoder)
		if err != nil {
			return err
		}
	}
	if header.ElementsOrVersion >= 0 {
		...
		if pointer0 == 0 {
			...
			s.Identifier = new(ConstantReference)
			if err := (*s.Identifier).Decode(decoder); err != nil {
				return err
			}
		}
	}
...
func (s *EnumConstantValue) Encode(encoder *bindings.Encoder) error {
	encoder.StartStruct(24, 0)
	if err := encoder.WritePointer(); err != nil {
		return err
	}
	if err := s.EnumType.Encode(encoder); err != nil {
		return err
	}
	if s.EnumValueName == nil {
		encoder.WriteNullPointer()
	} else {
		if err := encoder.WritePointer(); err != nil {
			return err
		}
		if err := encoder.WriteString((*s.EnumValueName)); err != nil {
			return err
		}
	}
...
var enumConstantValue_Versions []bindings.DataHeader = []bindings.DataHeader{
	bindings.DataHeader{32, 0},
}

func (s *EnumConstantValue) Decode(decoder *bindings.Decoder) error {
	header, err := decoder.StartStruct()
	if err != nil {
		return err
	}
	index := sort.Search(len(enumConstantValue_Versions), func(i int) bool {
		return enumConstantValue_Versions[i].ElementsOrVersion >= header.ElementsOrVersion
	})
	if index < len(enumConstantValue_Versions) {
		if enumConstantValue_Versions[index].ElementsOrVersion > header.ElementsOrVersion {
			index--
		}
		expectedSize := enumConstantValue_Versions[index].Size
		if expectedSize != header.Size {
			return &bindings.ValidationError{bindings.UnexpectedStructHeader,
				fmt.Sprintf("invalid struct header size: should be %d, but was %d", expectedSize, header.Size),
			}
	...
	if header.ElementsOrVersion >= 0 {
		...
		if pointer0 == 0 {
			...
			if err := s.EnumType.Decode(decoder); err != nil {
				return err
			}
		}
	}
	if header.ElementsOrVersion >= 0 {
		...
		if pointer0 == 0 {
			...
			s.EnumValueName = new(string)
			value0, err := decoder.ReadString()
			if err != nil {
				return err
			}
			(*s.EnumValueName) = value0
		}
	}
	if header.ElementsOrVersion >= 0 {
		value0, err := decoder.ReadInt32()
...
type ConstantValue interface {
	Tag() uint32
	Interface() interface{}
	__Reflect(__ConstantValueReflect)
	Encode(encoder *bindings.Encoder) error
}

type __ConstantValueReflect struct {
	BoolValue bool
	DoubleValue float64
	FloatValue float32
	Int8Value int8
	...
	Uint32Value uint32
	Uint64Value uint64
	EnumValue EnumConstantValue
}

func DecodeConstantValue(decoder *bindings.Decoder) (ConstantValue, error) {
	size, tag, err := decoder.ReadUnionHeader()
	if err != nil {
		return nil, err
	}
	...
	switch tag {
	case 0:
		var value ConstantValueBoolValue
		if err := value.decodeInternal(decoder); err != nil {
			return nil, err
		}
		decoder.FinishReadingUnionValue()
		return &value, nil
	case 1:
		var value ConstantValueDoubleValue
		if err := value.decodeInternal(decoder); err != nil {
			return nil, err
		}
		decoder.FinishReadingUnionValue()
		return &value, nil
	case 2:
		var value ConstantValueFloatValue
		if err := value.decodeInternal(decoder); err != nil {
			return nil, err
		}
		decoder.FinishReadingUnionValue()
		return &value, nil
	case 3:
		var value ConstantValueInt8Value
		if err := value.decodeInternal(decoder); err != nil {
			return nil, err
		}
		decoder.FinishReadingUnionValue()
		return &value, nil
	case 4:
		var value ConstantValueInt16Value
		if err := value.decodeInternal(decoder); err != nil {
			return nil, err
		}
		decoder.FinishReadingUnionValue()
		return &value, nil
	case 5:
		var value ConstantValueInt32Value
		if err := value.decodeInternal(decoder); err != nil {
			return nil, err
		}
		decoder.FinishReadingUnionValue()
		return &value, nil
	case 6:
		var value ConstantValueInt64Value
		if err := value.decodeInternal(decoder); err != nil {
			return nil, err
		}
		decoder.FinishReadingUnionValue()
		return &value, nil
	case 7:
		var value ConstantValueStringValue
		if err := value.decodeInternal(decoder); err != nil {
			return nil, err
		}
		decoder.FinishReadingUnionValue()
		return &value, nil
	case 8:
		var value ConstantValueUint8Value
		if err := value.decodeInternal(decoder); err != nil {
			return nil, err
		}
		decoder.FinishReadingUnionValue()
		return &value, nil
	case 9:
		var value ConstantValueUint16Value
		if err := value.decodeInternal(decoder); err != nil {
			return nil, err
		}
		decoder.FinishReadingUnionValue()
		return &value, nil
	case 10:
		var value ConstantValueUint32Value
		if err := value.decodeInternal(decoder); err != nil {
			return nil, err
		}
		decoder.FinishReadingUnionValue()
		return &value, nil
	case 11:
		var value ConstantValueUint64Value
		if err := value.decodeInternal(decoder); err != nil {
			return nil, err
		}
		decoder.FinishReadingUnionValue()
		return &value, nil
	case 12:
		var value ConstantValueEnumValue
		if err := value.decodeInternal(decoder); err != nil {
			return nil, err
		}
		decoder.FinishReadingUnionValue()
	...
	decoder.SkipUnionValue()
	return &ConstantValueUnknown{tag: tag}, nil
}

type ConstantValueUnknown struct { tag uint32 }
func (u *ConstantValueUnknown) Tag() uint32 { return u.tag }
func (u *ConstantValueUnknown) Interface() interface{} { return nil }
func (u *ConstantValueUnknown) __Reflect(__ConstantValueReflect) {}

func (u *ConstantValueUnknown) Encode(encoder *bindings.Encoder) error {
	return fmt.Errorf("Trying to serialize an unknown ConstantValue. There is no sane way to do that!");
}

type ConstantValueBoolValue struct { Value bool }
func (u *ConstantValueBoolValue) Tag() uint32 { return 0 }
func (u *ConstantValueBoolValue) Interface() interface{} { return u.Value }
func (u *ConstantValueBoolValue) __Reflect(__ConstantValueReflect) {}

func (u *ConstantValueBoolValue) Encode(encoder *bindings.Encoder) error {
	encoder.WriteUnionHeader(u.Tag())
...
func (u *ConstantValueBoolValue) decodeInternal(decoder *bindings.Decoder) error {
	value0, err := decoder.ReadBool()
	if err != nil {
		return err
	}
...
type ConstantValueDoubleValue struct { Value float64 }
func (u *ConstantValueDoubleValue) Tag() uint32 { return 1 }
func (u *ConstantValueDoubleValue) Interface() interface{} { return u.Value }
func (u *ConstantValueDoubleValue) __Reflect(__ConstantValueReflect) {}

func (u *ConstantValueDoubleValue) Encode(encoder *bindings.Encoder) error {
	encoder.WriteUnionHeader(u.Tag())
...
func (u *ConstantValueDoubleValue) decodeInternal(decoder *bindings.Decoder) error {
...
type ConstantValueFloatValue struct { Value float32 }
func (u *ConstantValueFloatValue) Tag() uint32 { return 2 }
func (u *ConstantValueFloatValue) Interface() interface{} { return u.Value }
func (u *ConstantValueFloatValue) __Reflect(__ConstantValueReflect) {}

func (u *ConstantValueFloatValue) Encode(encoder *bindings.Encoder) error {
	encoder.WriteUnionHeader(u.Tag())
...
func (u *ConstantValueFloatValue) decodeInternal(decoder *bindings.Decoder) error {
...
type ConstantValueInt8Value struct { Value int8 }
func (u *ConstantValueInt8Value) Tag() uint32 { return 3 }
func (u *ConstantValueInt8Value) Interface() interface{} { return u.Value }
func (u *ConstantValueInt8Value) __Reflect(__ConstantValueReflect) {}

func (u *ConstantValueInt8Value) Encode(encoder *bindings.Encoder) error {
	encoder.WriteUnionHeader(u.Tag())
...
func (u *ConstantValueInt8Value) decodeInternal(decoder *bindings.Decoder) error {
...
type ConstantValueInt16Value struct { Value int16 }
func (u *ConstantValueInt16Value) Tag() uint32 { return 4 }
func (u *ConstantValueInt16Value) Interface() interface{} { return u.Value }
func (u *ConstantValueInt16Value) __Reflect(__ConstantValueReflect) {}

func (u *ConstantValueInt16Value) Encode(encoder *bindings.Encoder) error {
	encoder.WriteUnionHeader(u.Tag())
...
func (u *ConstantValueInt16Value) decodeInternal(decoder *bindings.Decoder) error {
...
type ConstantValueInt32Value struct { Value int32 }
func (u *ConstantValueInt32Value) Tag() uint32 { return 5 }
func (u *ConstantValueInt32Value) Interface() interface{} { return u.Value }
func (u *ConstantValueInt32Value) __Reflect(__ConstantValueReflect) {}

func (u *ConstantValueInt32Value) Encode(encoder *bindings.Encoder) error {
	encoder.WriteUnionHeader(u.Tag())
...
func (u *ConstantValueInt32Value) decodeInternal(decoder *bindings.Decoder) error {
	value0, err := decoder.ReadInt32()
	if err != nil {
		return err
	}
...
type ConstantValueInt64Value struct { Value int64 }
func (u *ConstantValueInt64Value) Tag() uint32 { return 6 }
func (u *ConstantValueInt64Value) Interface() interface{} { return u.Value }
func (u *ConstantValueInt64Value) __Reflect(__ConstantValueReflect) {}

func (u *ConstantValueInt64Value) Encode(encoder *bindings.Encoder) error {
	encoder.WriteUnionHeader(u.Tag())
...
func (u *ConstantValueInt64Value) decodeInternal(decoder *bindings.Decoder) error {
...
type ConstantValueStringValue struct { Value string }
func (u *ConstantValueStringValue) Tag() uint32 { return 7 }
func (u *ConstantValueStringValue) Interface() interface{} { return u.Value }
func (u *ConstantValueStringValue) __Reflect(__ConstantValueReflect) {}

func (u *ConstantValueStringValue) Encode(encoder *bindings.Encoder) error {
	encoder.WriteUnionHeader(u.Tag())
	if err := encoder.WritePointer(); err != nil {
		return err
	}
...
func (u *ConstantValueStringValue) decodeInternal(decoder *bindings.Decoder) error {
	pointer0, err := decoder.ReadPointer()
	if err != nil {
		return err
	}
...
type ConstantValueUint8Value struct { Value uint8 }
func (u *ConstantValueUint8Value) Tag() uint32 { return 8 }
func (u *ConstantValueUint8Value) Interface() interface{} { return u.Value }
func (u *ConstantValueUint8Value) __Reflect(__ConstantValueReflect) {}

func (u *ConstantValueUint8Value) Encode(encoder *bindings.Encoder) error {
	encoder.WriteUnionHeader(u.Tag())
...
func (u *ConstantValueUint8Value) decodeInternal(decoder *bindings.Decoder) error {
...
type ConstantValueUint16Value struct { Value uint16 }
func (u *ConstantValueUint16Value) Tag() uint32 { return 9 }
func (u *ConstantValueUint16Value) Interface() interface{} { return u.Value }
func (u *ConstantValueUint16Value) __Reflect(__ConstantValueReflect) {}

func (u *ConstantValueUint16Value) Encode(encoder *bindings.Encoder) error {
	encoder.WriteUnionHeader(u.Tag())
...
func (u *ConstantValueUint16Value) decodeInternal(decoder *bindings.Decoder) error {
...
type ConstantValueUint32Value struct { Value uint32 }
func (u *ConstantValueUint32Value) Tag() uint32 { return 10 }
func (u *ConstantValueUint32Value) Interface() interface{} { return u.Value }
func (u *ConstantValueUint32Value) __Reflect(__ConstantValueReflect) {}

func (u *ConstantValueUint32Value) Encode(encoder *bindings.Encoder) error {
	encoder.WriteUnionHeader(u.Tag())
...
func (u *ConstantValueUint32Value) decodeInternal(decoder *bindings.Decoder) error {
	value0, err := decoder.ReadUint32()
	if err != nil {
		return err
	}
...
type ConstantValueUint64Value struct { Value uint64 }
func (u *ConstantValueUint64Value) Tag() uint32 { return 11 }
func (u *ConstantValueUint64Value) Interface() interface{} { return u.Value }
func (u *ConstantValueUint64Value) __Reflect(__ConstantValueReflect) {}

func (u *ConstantValueUint64Value) Encode(encoder *bindings.Encoder) error {
	encoder.WriteUnionHeader(u.Tag())
...
func (u *ConstantValueUint64Value) decodeInternal(decoder *bindings.Decoder) error {
...
type ConstantValueEnumValue struct { Value EnumConstantValue }
func (u *ConstantValueEnumValue) Tag() uint32 { return 12 }
func (u *ConstantValueEnumValue) Interface() interface{} { return u.Value }
func (u *ConstantValueEnumValue) __Reflect(__ConstantValueReflect) {}

func (u *ConstantValueEnumValue) Encode(encoder *bindings.Encoder) error {
	encoder.WriteUnionHeader(u.Tag())
	if err := encoder.WritePointer(); err != nil {
		return err
	}
...
func (u *ConstantValueEnumValue) decodeInternal(decoder *bindings.Decoder) error {
	pointer0, err := decoder.ReadPointer()
	if err != nil {
		return err
	}
